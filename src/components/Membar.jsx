...
const Membar = () => {
  ...
  function SamplePrevArrow(props) {
    ...
    return (
        <div
        className={`${className} px-5 py-2 border w-14 rounded-xl border-[#D0D5DD] text-[#0872BA] absolute top-0 right-28 cursor-pointer z-10`}
        onClick={onClick}
      >
        <FaArrowLeft />
  ...
  return (
    <div className="pt-[130px] w-[1212px] mx-auto">
      <div className="font-monts leading-[140%] bg-[rgba(8,114,186,.3)] w-[146px] mx-auto py-3 rounded-lg text-center -rotate-[15deg] mb-4">
        Testimonial
      </div>
      <h2 className="text-center bold ">What Our Members Say</h2>
      <p className="text-xl font-medium font-monts leading-[140%] text-[#344054] text-center mt-5  w-full xl:w-[1021px] mx-auto mb-[68px] md:w-[700px]">
      ...
      <Slider {...settings}>
            ...
            <div className="xl:w-[444px] w-full bg-[#0872BA] rounded-2xl p-5 xl:p-10 xl:pr-20">
              <div className="flex items-center justify-between">
                <div className="w-[88px] h-[88px] rounded-full bg-white">
                  <img className="object-contain w-full h-full rounded-full" src={s1} alt="" />
                </div>
        ...
        <div>
          <div className="flex items-center justify-between">
            <div className="w-[444px] bg-[#0872BA] rounded-2xl p-10 pr-20">
              <div className="flex items-center justify-between">
                <div className="w-[88px] h-[88px] rounded-full bg-white">
                  <img src="" alt="" />
                </div>
            ...
            <div>
              <p className="text-2xl font-medium font-monts leading-[164%] text-[#344054] w-[597px]">
                Our smart developers build innovative, efficient, and high-
                performance solutions. efficient, and high- performance
                solutions. efficient, and high- performance solutions.
              </p>
